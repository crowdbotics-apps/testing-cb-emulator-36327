...
## Project Structure
    ...
    ├── testing_cb_emulator_36327  # Django project configurations
...
1. Clone this repo and `cd testing_cb_emulator_36327`
...
2. Clone this repo and `cd testing_cb_emulator_36327`
